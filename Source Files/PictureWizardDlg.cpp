...
{
	horizontal = false;
	MessageBox("Taking the vertical picture now...");
...
void CPictureWizardDlg::OnHSelect()
{
	...
	CFileDialog dlg(TRUE/*Open=TRUE Save=False*/,NULL/*Filename Extension*/,"Horizontal photo"/*Initial Filename*/,OFN_ENABLESIZING|OFN_EXPLORER|OFN_FILEMUSTEXIST/*Flags*/,"JPG(*.jpg)|*.jpg||"/*Filetype Filter*/,this/*parent Window*/);
...
void CPictureWizardDlg::OnVSelect()
{
	...
	CString initialDir = cur_path+"\\"+ my_roster->GetLabel();
	CFileDialog dlg(TRUE/*Open=TRUE Save=False*/,NULL/*Filename Extension*/,"Vertical photo"/*Initial Filename*/,OFN_ENABLESIZING|OFN_EXPLORER|OFN_FILEMUSTEXIST/*Flags*/,"JPG(*.jpg)|*.jpg||"/*Filetype Filter*/,this/*parent Window*/);
	dlg.m_ofn.lpstrInitialDir= initialDir;
